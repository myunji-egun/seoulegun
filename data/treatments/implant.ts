...
4~6개로 전체를 한 번에, **더 빠르고 더 단단하게.**`,
    benefits: [
      { tag: '소수 임플란트로 전체 치아 기능 회복', description: '소수의 임플란트로 전체 치아 기능 회복을 계획할 수 있습니다.' },
      { tag: '틀니 불편함에서 벗어나기', description: '틀니 사용에 따른 불편함을 줄이는 데 도움이 될 수 있습니다.' },
      { tag: '뼈 이식 없이 식립 가능한 경우도', description: '뼈 이식 없이도 식립이 가능한 경우가 있어 수술 부담을 줄일 수 있습니다.' },
      { tag: '안정적인 씹는 기능 회복', description: '보철 구조를 함께 설계하여 안정적인 씹는 기능 회복을 기대할 수 있습니다.' },
      { tag: '개인 맞춤 치료 계획', description: '환자 상태에 맞춰 치료 계획을 개별적으로 수립할 수 있습니다.' },
    ],
    faq: [
      {
...
기다림 없이, **바로 일상으로.**`,
    benefits: [
      { tag: '당일 임시치아 연결', description: '식립 당일 임시치아를 연결하여 심미적 공백을 줄일 수 있습니다.' },
      { tag: '치아 없는 기간 최소화', description: '치아가 없는 불편한 기간을 최소화하는 데 도움이 됩니다.' },
      { tag: '치료 기간 단축 가능', description: '적절한 증례에서는 전체 치료 기간을 단축할 수 있습니다.' },
      { tag: '초기 고정력 확인 후 적용', description: '초기 고정력이 충분한 경우에 적용을 고려할 수 있습니다.' },
      { tag: '빠른 일상 복귀', description: '일상생활 복귀까지의 시간을 줄이는 데 도움이 됩니다.' },
    ],
    faq: [
      {
