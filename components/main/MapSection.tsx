    ...
    <section ref={ref} className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-y-0 left-0 z-10 flex items-center pl-4 md:pl-10">
        <div className="flex flex-col gap-2.5 max-w-[300px] w-[calc(100vw-2rem)] md:w-auto">
          {/* 치과 정보 카드 */}
          <div className={`bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-4 md:p-5 ${isVisible ? 'scroll-reveal-up' : 'scroll-hidden'}`}>
            <img
          ...
          {/* 진료시간 카드 */}
          <div className={`bg-white/95 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden ${isVisible ? 'scroll-reveal-up' : 'scroll-hidden'}`}
