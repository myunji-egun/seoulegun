    ...
    <footer className="bg-white text-gray-800 border-t border-gray-100">
      ...
      <div className="border-t border-gray-100 bg-gray-50 px-6 lg:px-10 py-5">
        <div className="max-w-7xl mx-auto">
          {/* 사업자 정보 한 줄 */}
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-gray-400 mb-2">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            <Link href="/privacy" className="text-[10px] text-gray-400 hover:text-[#0080C8] transition-colors">
              개인정보처리방침
            </Link>
          </div>
        </div>
